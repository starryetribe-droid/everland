        ...
        <SectionWrapper id="proposal-objective" className="bg-white relative overflow-hidden" pageNumber={5}>
            <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
                ...
                <div className="text-center mb-16">
                    <FadeIn>
                        <span className="text-[#7730D0] font-bold tracking-wider text-lg uppercase mb-2 block">Objective</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                    ...
                    <FadeIn delay={100} className="bg-gray-50 rounded-2xl p-8 border border-gray-100 flex flex-col justify-center h-full">
                        <div className="mb-6">
                            <span className="inline-block px-3 py-1 bg-gray-200 text-gray-700 text-lg font-bold rounded-full mb-3">제안 배경</span>
                        ...
                        <div>
                            <span className="inline-block px-3 py-1 bg-gray-200 text-gray-700 text-lg font-bold rounded-full mb-3">제안 요약</span>
                    ...
                    <FadeIn delay={200} className="relative rounded-2xl overflow-hidden shadow-xl aspect-[4/3] md:aspect-auto">
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-center h-full p-10 text-center text-white">
                            ...
                            <span className="font-bold text-white/80 uppercase tracking-widest text-lg mb-4">Core Goal</span>
                            <h3 className="text-3xl md:text-4xl font-extrabold leading-tight mb-4">
                                Experience <br /> redefined
                            </h3>
                            <p className="text-xl md:text-2xl font-medium text-white/90 leading-relaxed max-w-sm">
                                에버랜드 브랜드를<br />
