...
import seasonSquidGame from '../../src/assets/images/season_squidgame_theme_1768308652443.png';
        ...
        <SectionWrapper id="season-rotation" className="bg-white relative overflow-hidden" pageNumber={12}>
            <div className="max-w-7xl mx-auto px-6 w-full relative z-10 flex flex-col items-center">
                ...
                <div className="text-center mb-12 max-w-4xl">
                    <FadeIn>
                        <span className="text-[#7730D0] font-bold tracking-wider text-[15px] uppercase mb-2 block">Infinite Scalability</span>
                        <h2 className="text-3xl md:text-5xl font-extrabold text-monimo-black leading-tight mb-6">
                    ...
                    <FadeIn delay={600} className="w-full md:w-5/12 z-0">
                        <div className="relative group">
                            ...
                            <div className="relative bg-white p-2 rounded-[2rem] border border-gray-100 shadow-xl overflow-hidden">
                                ...
                                <div className="aspect-[4/3] rounded-[1.5rem] overflow-hidden relative">
                                    <img src={seasonSquidGame} alt="Season 2: K-Drama Theme (Squid Game)" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                                    <div className="absolute bottom-6 left-0 w-full text-center">
                                        ...
                                        <p className="text-sm text-gray-200 font-medium mt-1">Global Hit: Squid Game</p>
                                    </div>

                                    {/* Overlay shape icons reminiscent of the show */}
                                    <div className="absolute top-4 right-4 flex gap-2 opacity-80">
                                        <div className="w-6 h-6 border-2 border-white rounded-full"></div>
                                        <div className="w-6 h-6 border-2 border-white"></div>
                                        <div className="w-6 h-6 border-2 border-white transform rotate-45 scale-75 origin-center"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
